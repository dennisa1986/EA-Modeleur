...
class ErrorCode(StrEnum):
    ...
    METAMODEL_REGISTRY_EXPORT_FAIL = "META-004"
    METAMODEL_DESCRIPTION_PARSE_ERROR = "META-005"

    # Canonical model
    CANONICAL_SCHEMA_VIOLATION = "CANON-001"
    CANONICAL_MISSING_PROVENANCE = "CANON-002"
    CANONICAL_IO_READ_FAIL = "CANON-003"
    CANONICAL_IO_WRITE_FAIL = "CANON-004"
    CANONICAL_DANGLING_REFERENCE = "CANON-005"
    CANONICAL_DUPLICATE_ID = "CANON-006"
